 ...
 * based on https://github.com/hard-g/openlab-bmcc/blob/master/wp-content/themes/openlab-bmcc/parts/home/login.php removing specific references to BMCC
 * @since 1.0.0
 */
...
<?php else : ?>
	...
	<?php printf(
		...
		'Register for an account in just a few minutes.'
	); ?>
	<?php echo '</div>'; ?>
	...
	<div id="user-login" class="log-box">
		...
		<?php printf(
			...
			'Already have an account? Log in using your username and password.'
		); ?>
	</div>
<?php endif; ?>